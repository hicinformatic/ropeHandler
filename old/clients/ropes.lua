...
function pullRope(from, to, step, rope)
    local fromPos = GetEntityCoords(from)
    local toPos = GetEntityCoords(to)
    ...
    local force = step -- Ajustez la force selon vos besoins
    ...
    --     local fromPos = GetEntityCoords(from)
    --     local toPos = GetEntityCoords(to)
    --     ropeLength = GetDistanceBetweenCoords(fromPos, toPos, true)
    --     RopeForceLength(rope, ropeLength)
    -- end
end

-- Fonction pour pousser le personnage loin du grappin
function pushRope(from, to, step)
    local fromPos = GetEntityCoords(from)
    local toPos = GetEntityCoords(to)
    local distance = #(fromPos - toPos)
    ...
    local force = step -- Utiliser le pas comme force
